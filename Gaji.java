public class Gaji extends Pegawai {/*
                                    * extend merupakan salah satu syarat
    ...
    public void mailCheck() {
        /*
         * method mailcheck() adalah method yang dimiliki oleh subclass yaitu class
         * pegawai,dimana terjadi
         * overriding karna memiliki nama yang sama dengan method yg ada pada
         * superclass,karna method pada subclass
         * ini mengubah isinya dengan atau referensinya yg mana bukan lagi bereferensi
         * pada superclass.Maka ini dinamakan
         * UPCASTING
         */
